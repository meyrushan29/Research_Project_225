...
# Fix Windows asyncio socket errors (Data should not be empty) inside the worker process
...
fitness_video_path = os.path.join(os.getcwd(), "img", "fitness_processed")
os.makedirs(fitness_video_path, exist_ok=True)
app.mount("/fitness_videos", StaticFiles(directory=fitness_video_path), name="fitness_videos")
