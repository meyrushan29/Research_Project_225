...
class AdvancedModelTrainer:
    ...
    def prepare_features(self, df: pd.DataFrame):
        ...
        # 🔥 CRITICAL FIX: APPLY FEATURE ENGINEERING BEFORE SPLIT
        ...
        if "Urine_Health_Score" not in df_engineered.columns:
            raise ValueError("Feature Engineering failed to add columns!")
    ...
    def save_all(self):
        ...
        # MODEL_DIR is imported from config
