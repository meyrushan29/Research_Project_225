      ...
      builder: (ctx) => BackdropFilter(
        ...
        child: AlertDialog(
          ...
          content: Column(
            ...
            children: [
              _instructionItem(Icons.wb_sunny_outlined, "Bright natural lighting is best"),
              ...
              _instructionItem(Icons.center_focus_strong_outlined, "Align within the pulsing ring"),
            ],
          ),
          actions: [
            TextButton(
