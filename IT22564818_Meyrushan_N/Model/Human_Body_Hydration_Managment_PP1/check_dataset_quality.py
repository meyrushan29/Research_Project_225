...
This script analyzes the dataset to identify problematic images where:
1. Background takes up too much space
2. Lips are not properly focused/centered
3. Image quality issues
4. Inconsistent cropping
"""
        ...
        for category in categories:
            ...
            for img_path in sorted(image_files):
                ...
                if result['issues']:
                    ...
                    print(f"\n{severity_icon} {img_path.name} ({result['severity'].upper()} priority)")
